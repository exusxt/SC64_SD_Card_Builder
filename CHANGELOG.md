...
- Show the N64 ROM description at the right position in the preview footer

### Infra

- Refresh README for v0.11.2

[Compare v0.11.2...v0.11.3](https://github.com/exusxt/SC64_SD_Card_Builder/compare/v0.11.2...v0.11.3)

## [v0.11.2] - 2026-08-04

### Fixed

- Show the N64 ROM description in the preview footer instead of over the file list

[Compare v0.11.1...v0.11.2](https://github.com/exusxt/SC64_SD_Card_Builder/compare/v0.11.1...v0.11.2)

## [v0.11.1] - 2026-08-04

### Fixed

- Keep the preview file list inside its area for long listings

[Compare v0.11.0...v0.11.1](https://github.com/exusxt/SC64_SD_Card_Builder/compare/v0.11.0...v0.11.1)
